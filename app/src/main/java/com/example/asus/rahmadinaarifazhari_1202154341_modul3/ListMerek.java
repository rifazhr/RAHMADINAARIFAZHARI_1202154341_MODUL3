...
public class ListMerek extends AppCompatActivity {
    RecyclerView recv;
    AdapterMerk adptr;
    List<MenuMerk> listmerk;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_merk);
        ...
        if(getResources().getConfiguration().orientation== Configuration.ORIENTATION_LANDSCAPE){
            ...
            recv.setLayoutManager(new GridLayoutManager(ListMerek.this, 2));
            //jika orientasi menjadi portrait
        }else {
            //maka akan menampilkan satu grid saja
            recv.setLayoutManager(new GridLayoutManager(ListMerek.this, 1));
        }
